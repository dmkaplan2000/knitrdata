...
```{data key,output.file="key",include=FALSE,eval=requireNamespace("gpg")}
-----BEGIN PGP PRIVATE KEY BLOCK-----
...
```{r importkey,eval=requireNamespace("gpg")}
gpg::gpg_import("key")
```
...
```{data t3,format="binary",encoding="gpg",output.file="test_output2.RDS",include=FALSE,eval=requireNamespace("gpg")}
-----BEGIN PGP MESSAGE-----
Version: GnuPG v2
...
```{r deletekey,eval=requireNamespace("gpg"),include=FALSE}
