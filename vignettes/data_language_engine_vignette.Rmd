...
Now that we have this private key, we can decode some binary data encrypted using this key:
    ...
    `r ''````{data t3,format="binary",encoding="gpg",output.file="test_output2.RDS"}
    -----BEGIN PGP MESSAGE-----
    Version: GnuPG v2
...
```{data t3,format="binary",encoding="gpg",output.file="test_output2.RDS",include=FALSE,eval=requireNamespace("gpg") && params$run_gpg}
-----BEGIN PGP MESSAGE-----
Version: GnuPG v2
