...
These concerns do not apply to `base64` or `gpg` encoded text files as the exact text file contents, including line endings, are encoded in the chunk contents.
...
As a final workaround to this problem, one can remove the password from the relevant GPG key in the keyring manager before knitting, though this is not recommended.
