...
Text contents of the chunk will be read into the variable `d`. This can then be converted into a data.frame using `read.csv`:
...
```{data t3,format="binary",encoding="gpg",output.file="test_output2.RDS",eval=requireNamespace("gpg") && params$run_gpg}
-----BEGIN PGP MESSAGE-----
Version: GnuPG v2
